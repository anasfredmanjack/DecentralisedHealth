(function($) {
 ...
 var dlabSparkLine = function(){
	...
	var sparkline99 = function(){
		if(jQuery('#sparkline99').length > 0 ){	
			$("#sparkline99").sparkline([79, 72, 29, 6, 52, 32, 73, 40, 14, 75, 77, 39, 9, 15, 10], {
				type: "line",
				//width: "100%",
				width: getSparkLineGraphBlockSize('#sparkline99'),
				height: "50",
				lineColor: "#0d99ff",
