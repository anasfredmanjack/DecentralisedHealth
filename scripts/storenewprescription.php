...
$openAISecretKey = "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";
...
//== ===    script to generate customised health plan based on doctors prescription and tips from  Likyta ai using chatgpt======= ======//
$dateofbirth = $fetch['dateofbirth'];
$weight = $fetch['weight'];
$allergies = $fetch['allergies']; 
$familypastmedicalhistory = $fetch['familypastmedicalhistory'];
...
$modifiedprompt = "
You are Likyta, an AI medical assistant designed to assist in creating health plans and offering tips based on a user's medical profile. The user has recently had a medical consultation, and you have access to the following information:
...
//== ===    script to generate customised health plan based on doctors prescription and tips from  Likyta ai using chatgpt ends here======= ======//
...
<div align="center" style="line-height:10px"><img src="https://likyta.com.ng/users/assets/images/logo-stiky.png" style="display: block; height: auto; border: 0; width: 200px; max-width: 100%;" width="200"/></div>
</td>
</tr>
</table>
</td>
...
<!--<![endif]-->
                    ...
                    $to = $patientemail;
                    $nameto = 'Hello User';
                    $subject = 'Likyta  AI Personalized Health Plan and Tips';
                    $email = 'info@likyta.com.ng';
                    $nameto = 'Likyta User';
                       ...
                       try {
                           ...
                           $mail->Host       = 'likyta.com.ng';                     //Set the SMTP server to send through
                           $mail->SMTPAuth   = true;                                   //Enable SMTP authentication
                           $mail->Username   = 'info@likyta.com.ng';                     //SMTP username
